      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/o-to" className="hover:text-white transition">Tất cả ô tô</Link></li>
            <li><Link href="/o-to?type=sedan" className="hover:text-white transition">Sedan</Link></li>
            <li><Link href="/o-to?type=suv" className="hover:text-white transition">SUV</Link></li>
            <li><Link href="/o-to?type=mpv" className="hover:text-white transition">MPV</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/xe-may?type=xe-ga" className="hover:text-white transition">Xe ga</Link></li>
            <li><Link href="/xe-may?type=sportbike" className="hover:text-white transition">Sportbike</Link></li>
            <li><Link href="/xe-may?type=xe-dien" className="hover:text-white transition">Xe điện</Link></li>
          </ul>
        </div>
        <div>
